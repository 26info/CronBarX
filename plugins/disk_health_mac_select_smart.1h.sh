...
get_key_attributes() {
    ...
    declare -A attr_descriptions=(
        ["1"]="Частота ошибок чтения"
        ["5"]="Перераспределенные блоки NAND"
        ["9"]="Время работы"
        ["12"]="Циклы включения"
        ["171"]="Ошибки программирования"
        ["172"]="Ошибки стирания"
        ["173"]="Среднее количество стираний блоков"
        ["174"]="Неожиданные отключения питания"
        ["180"]="Резервные блоки NAND"
        ["183"]="Снижение скорости SATA"
        ["184"]="Коррекция ошибок"
        ["187"]="Некорректируемые ошибки"
        ["196"]="События перераспределения"
        ["197"]="Ожидающие ошибки ECC"
        ["198"]="Оффлайн некорректируемые"
        ["199"]="Ошибки CRC интерфейса"
        ["202"]="Оставшийся ресурс"
        ["206"]="Частота ошибок записи"
        ["210"]="Успешные восстановления RAIN"
        ["246"]="Всего записано данных"
        ["247"]="Страниц записано хостом"
        ["248"]="Страниц записано контроллером"
    )
    ...
    for attr_id in "${key_attrs[@]}"; do
        ...
        local description="${attr_descriptions[$attr_id]}"
